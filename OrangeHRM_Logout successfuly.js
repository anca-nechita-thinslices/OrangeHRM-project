...
(async()=>{
    ...
    {
        const targetPage = page;
        await scrollIntoViewIfNeeded([["#app > div.orangehrm-login-layout > div > div.orangehrm-login-container > div > div.orangehrm-login-slot > div.orangehrm-login-form > div > div > p:nth-child(2)"], ["xpath///*[@id=\"app\"]/div[1]/div/div[1]/div/div[2]/div[2]/div/div/p[2]"], ["text/Password : admin123"]], targetPage, timeout);
        const element = await waitForSelectors([["#app > div.orangehrm-login-layout > div > div.orangehrm-login-container > div > div.orangehrm-login-slot > div.orangehrm-login-form > div > div > p:nth-child(2)"], ["xpath///*[@id=\"app\"]/div[1]/div/div[1]/div/div[2]/div[2]/div/div/p[2]"], ["text/Password : admin123"]], targetPage, {
            timeout,
            visible: true
        });
        await element.click({
            delay: 719.8999999985099,
            offset: {
                x: 218.1640625,
                y: 69.1328125,
            },
    ...
    }
    {
        ...
        const inputType = await element.evaluate(el=>el.type);
        if (inputType === 'select-one') {
            await changeSelectElement(element, "admin123")
        } else if (["textarea", "text", "url", "tel", "search", "password", "number", "email"].includes(inputType)) {
            await typeIntoElement(element, "admin123");
        } else {
            await changeElementValue(element, "admin123");
        }
    }
    {
        const targetPage = page;
    ...
    {
        const targetPage = page;
        await scrollIntoViewIfNeeded([["#app > div.oxd-layout > div.oxd-layout-navigation > header > div.oxd-topbar-header > div.oxd-topbar-header-userarea > ul > li > span > i"], ["xpath///*[@id=\"app\"]/div[1]/div[1]/header/div[1]/div[2]/ul/li/span/i"]], targetPage, timeout);
        const element = await waitForSelectors([["#app > div.oxd-layout > div.oxd-layout-navigation > header > div.oxd-topbar-header > div.oxd-topbar-header-userarea > ul > li > span > i"], ["xpath///*[@id=\"app\"]/div[1]/div[1]/header/div[1]/div[2]/ul/li/span/i"]], targetPage, {
            timeout,
            visible: true
        });
        await element.click({
    ...
    }
    {
        ...
        const promises = [];
        promises.push(targetPage.waitForNavigation());
        await scrollIntoViewIfNeeded([["aria/Logout"], ["#app > div.oxd-layout > div.oxd-layout-navigation > header > div.oxd-topbar-header > div.oxd-topbar-header-userarea > ul > li > ul > li:nth-child(4) > a"], ["xpath///*[@id=\"app\"]/div[1]/div[1]/header/div[1]/div[2]/ul/li/ul/li[4]/a"], ["text/Logout"]], targetPage, timeout);
        const element = await waitForSelectors([["aria/Logout"], ["#app > div.oxd-layout > div.oxd-layout-navigation > header > div.oxd-topbar-header > div.oxd-topbar-header-userarea > ul > li > ul > li:nth-child(4) > a"], ["xpath///*[@id=\"app\"]/div[1]/div[1]/header/div[1]/div[2]/ul/li/ul/li[4]/a"], ["text/Logout"]], targetPage, {
            timeout,
            visible: true
        });
        await element.click({
