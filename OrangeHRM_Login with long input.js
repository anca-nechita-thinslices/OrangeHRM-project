...
(async()=>{
    ...
    }
    {
        ...
        if (inputType === 'select-one') {
            await changeSelectElement(element, "gfhgrhgfgerhfgre yiuy. uhfjerutuey grjhgjsbnsdufryutir erfrhtur https://www.google.com/search?q=google+translate&rlz=1C5CHFA_enRO1039RO1039&oq=g&aqs=chrome.0.69i59l3j0i67j46i67i199i465j69i59j69i60l2.1432j0j4&sourceid=chrome&ie=UTF-8")
        } else if (["textarea", "text", "url", "tel", "search", "password", "number", "email"].includes(inputType)) {
            await typeIntoElement(element, "gfhgrhgfgerhfgre yiuy. uhfjerutuey grjhgjsbnsdufryutir erfrhtur https://www.google.com/search?q=google+translate&rlz=1C5CHFA_enRO1039RO1039&oq=g&aqs=chrome.0.69i59l3j0i67j46i67i199i465j69i59j69i60l2.1432j0j4&sourceid=chrome&ie=UTF-8");
        } else {
            await changeElementValue(element, "gfhgrhgfgerhfgre yiuy. uhfjerutuey grjhgjsbnsdufryutir erfrhtur https://www.google.com/search?q=google+translate&rlz=1C5CHFA_enRO1039RO1039&oq=g&aqs=chrome.0.69i59l3j0i67j46i67i199i465j69i59j69i60l2.1432j0j4&sourceid=chrome&ie=UTF-8");
        }
    }
    {
        const targetPage = page;
    ...
    }
    {
        ...
        const inputType = await element.evaluate(el=>el.type);
        if (inputType === 'select-one') {
            await changeSelectElement(element, "adimnanjh")
        } else if (["textarea", "text", "url", "tel", "search", "password", "number", "email"].includes(inputType)) {
            await typeIntoElement(element, "adimnanjh");
        } else {
            await changeElementValue(element, "adimnanjh");
        }
    }
    {
        const targetPage = page;
